// Заперет на ввод символов, кроме числовых и точки
const numeric_dot_field_validation = (e: React.KeyboardEvent<HTMLInputElement>) => {
...
export default numeric_dot_field_validation;