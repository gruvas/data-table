...
const Table = observer(() => {
    ...
    const [tableElement, setTableElement] = React.useState<any[]>([])
    const [pageElement, setPageElement] = React.useState<any[]>([])


    function creating_page_elements(tableElement: any[]) {
